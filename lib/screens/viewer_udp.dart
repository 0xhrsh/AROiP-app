...
class UnityViewingWrapperUDP extends StatefulWidget {
  UnityViewingStateUDP createState() => UnityViewingStateUDP();
}

class UnityViewingStateUDP extends State<UnityViewingWrapperUDP> {
  ...
  void sendUpdate(String message) {
    clientSocket.send(utf8.encode("viewer " + message), address, port);
  }
